...
##  ক্লাসিক্যাল বিট (Classical Bits)
...
##  কোয়ান্টাম বিট (কিউবিট) - Quantum Bits (Qubits)
...
$$
|a\rangle = \begin{bmatrix} a_1 \ a_2 \end{bmatrix} \in \mathbb{C}^2,\qquad
...
### কম্পিউটার সায়েন্স দৃষ্টিভঙ্গি
